...
var _ak1211$tractor$Generated_WebApi$encodeAuthTempCode = function (x) {
	...
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'at',
				_1: _elm_lang$core$Json_Encode$string(x.at)
			},
			_1: {
				ctor: '::',
				_0: {
				...
				_0: {
					...
					_1: function (_p5) {
						return A2(
							_elm_lang$core$Maybe$withDefault,
							_elm_lang$core$Json_Encode$null,
							A2(_elm_lang$core$Maybe$map, _elm_lang$core$Json_Encode$string, _p5));
					}(x.caption)
				},
				_1: {
					ctor: '::',
	...
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'version',
				_1: _elm_lang$core$Json_Encode$string(x.version)
			},
			_1: {
				ctor: '::',
				_0: {
...
var _ak1211$tractor$Generated_WebApi$makeAuthorizationHeader = function (token) {
...
var _ak1211$tractor$Generated_WebApi$getApiV1Version = _elm_lang$http$Http$request(
	{
		...
		body: _elm_lang$http$Http$emptyBody,
		expect: _elm_lang$http$Http$expectJson(_ak1211$tractor$Generated_WebApi$decodeVerRev),
		timeout: _elm_lang$core$Maybe$Nothing,
		withCredentials: false
	});
...
var _ak1211$tractor$Generated_WebApi$postApiV1Auth = function (body) {
	return _elm_lang$http$Http$request(
		{
			method: 'POST',
			headers: {ctor: '[]'},
			...
			body: _elm_lang$http$Http$jsonBody(
				_ak1211$tractor$Generated_WebApi$encodeAuthTempCode(body)),
...
var _ak1211$tractor$Generated_WebApi$putApiV1StocksHistoryByMarketCode = F4(
				...
				body: _elm_lang$http$Http$jsonBody(
					function (_p12) {
						return _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _ak1211$tractor$Generated_WebApi$encodeApiOhlcv, _p12));
					}(body)),
				expect: _elm_lang$http$Http$expectJson(
					_elm_lang$core$Json_Decode$list(_ak1211$tractor$Generated_WebApi$decodeApiOhlcv)),
				timeout: _elm_lang$core$Maybe$Nothing,
		...
		return _elm_lang$http$Http$request(
			{
				...
				body: _elm_lang$http$Http$jsonBody(
					function (_p15) {
						return _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _ak1211$tractor$Generated_WebApi$encodeApiOhlcv, _p15));
					}(body)),
				expect: _elm_lang$http$Http$expectJson(
					_elm_lang$core$Json_Decode$list(_ak1211$tractor$Generated_WebApi$decodeApiOhlcv)),
				timeout: _elm_lang$core$Maybe$Nothing,
...
var _ak1211$tractor$Generated_WebApi$deleteApiV1StocksHistoryByMarketCode = F4(
	function (header_Authorization, capture_marketCode, query_tf, body) {
		var params = A2(
			_elm_lang$core$List$filter,
			function (_p16) {
		...
		return _elm_lang$http$Http$request(
			{
				...
				body: _elm_lang$http$Http$jsonBody(
					function (_p18) {
						return _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _ak1211$tractor$Generated_WebApi$encodeApiOhlcv, _p18));
					}(body)),
				expect: _elm_lang$http$Http$expectJson(
					_elm_lang$core$Json_Decode$list(_ak1211$tractor$Generated_WebApi$decodeApiOhlcv)),
				timeout: _elm_lang$core$Maybe$Nothing,
...
var _ak1211$tractor$Generated_WebApi$AuthTempCode = function (a) {
	return {code: a};
};
var _ak1211$tractor$Generated_WebApi$decodeAuthTempCode = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'code',
	_elm_lang$core$Json_Decode$string,
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_ak1211$tractor$Generated_WebApi$AuthTempCode));
		...
		return _elm_lang$http$Http$request(
			{
				...
				expect: _elm_lang$http$Http$expectStringResponse(
					function (_p19) {
						var _p20 = _p19;
						return _elm_lang$core$String$isEmpty(_p20.body) ? _elm_lang$core$Result$Ok(_ak1211$tractor$Generated_WebApi$NoContent) : _elm_lang$core$Result$Err('Expected the response body to be empty');
					}),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
			});
...
var _ak1211$tractor$AnalyticsPage_Msg$UrlChange = function (a) {
...
var _ak1211$tractor$AnalyticsPage_Model$initialModel = {
	accessToken: _elm_lang$core$Maybe$Nothing,
	marketCode: _elm_lang$core$Maybe$Nothing,
	histories: {ctor: '[]'},
	tab: 0,
	mdl: _debois$elm_mdl$Material$model
};
var _ak1211$tractor$AnalyticsPage_Model$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	_ak1211$tractor$AnalyticsPage_Model$initialModel,
	{
		ctor: '::',
		_0: _debois$elm_mdl$Material$init(_ak1211$tractor$AnalyticsPage_Msg$Mdl),
		_1: {ctor: '[]'}
	});
var _ak1211$tractor$AnalyticsPage_Model$clearModel = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{
			marketCode: _elm_lang$core$Maybe$Nothing,
...
var _ak1211$tractor$AnalyticsPage_Model$Model = F5(
	function (a, b, c, d, e) {
		return {accessToken: a, marketCode: b, histories: c, tab: d, mdl: e};
	});
				...
				if (_p0._0.ctor === 'Just') {
					...
					if (_p1.ctor === 'Just') {
						return A2(
							...
							{
								ctor: '::',
								_0: A2(_ak1211$tractor$AnalyticsPage_Update$getHistories, _p1._0, _p2),
								_1: {ctor: '[]'}
							});
					} else {
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									marketCode: _elm_lang$core$Maybe$Just(_p2),
									histories: {ctor: '[]'}
								}),
							{ctor: '[]'});
					}
				...
				if (_p0._1.ctor === 'Ok') {
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								marketCode: _elm_lang$core$Maybe$Just(_p0._0),
								histories: _p0._1._0
							}),
						{ctor: '[]'});
				} else {
					...
					return A2(
						...
						model,
						{
							...
							_0: A2(
								...
								_elm_lang$core$Basics$identity,
								_elm_lang$core$Task$succeed(
									_ak1211$tractor$AnalyticsPage_Msg$ChangeMarketCode(_p0._0._0))),
							_1: {ctor: '[]'}
						});
				} else {
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_ak1211$tractor$AnalyticsPage_Model$clearModel(model),
						{ctor: '[]'});
				}
			default:
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _ak1211$tractor$AnalyticsPage_View$tableOhlcv(model.histories),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
											...
											{ctor: '[]'},
											{
												...
												_1: {
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text(mc),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}
		...
		return A6(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _debois$elm_mdl$Material_Icon$i('widgets'),
						_1: {
							ctor: '::',
							_0: A2(
					...
					_0: A2(
						...
						},
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html$text('chart'),
									_1: {ctor: '[]'}
								}
							}
						}),
			...
			},
			{
				...
				_0: function () {
					...
					switch (_p4) {
						...
						case 1:
							return _ak1211$tractor$AnalyticsPage_View$chartView(model);
						default:
...
var _ak1211$tractor$PortfolioPage_Msg$UrlChange = function (a) {
	return {ctor: 'UrlChange', _0: a};
};
var _ak1211$tractor$PortfolioPage_Msg$DoneGetPortfolios = function (a) {
	return {ctor: 'DoneGetPortfolios', _0: a};
};
var _ak1211$tractor$PortfolioPage_Msg$RenewPortfolios = {ctor: 'RenewPortfolios'};
...
var _ak1211$tractor$PortfolioPage_Model$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	_ak1211$tractor$PortfolioPage_Model$initialModel,
	{
		ctor: '::',
		_0: _debois$elm_mdl$Material$init(_ak1211$tractor$PortfolioPage_Msg$Mdl),
		_1: {
			ctor: '::',
			_0: A2(
				_elm_lang$core$Task$perform,
				_elm_lang$core$Basics$identity,
				_elm_lang$core$Task$succeed(_ak1211$tractor$PortfolioPage_Msg$RenewPortfolios)),
			_1: {ctor: '[]'}
		}
	});
var _ak1211$tractor$PortfolioPage_Model$clearModel = _elm_lang$core$Basics$identity;
...
var _ak1211$tractor$UploadPage_Model$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	_ak1211$tractor$UploadPage_Model$initialModel,
	{
		ctor: '::',
		_0: _debois$elm_mdl$Material$init(_ak1211$tractor$UploadPage_Msg$Mdl),
		_1: {ctor: '[]'}
	});
var _ak1211$tractor$UploadPage_Model$clearModel = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{
			inDropZone: false,
...
var _ak1211$tractor$PortfolioPage_Update$getPortfolios = A2(_elm_lang$http$Http$send, _ak1211$tractor$PortfolioPage_Msg$DoneGetPortfolios, _ak1211$tractor$Generated_WebApi$getApiV1Portfolios);
		...
		switch (_p0.ctor) {
				...
				if (_p0._0.ctor === 'Just') {
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								accessToken: _elm_lang$core$Maybe$Just(_p0._0._0)
							}),
						{
							ctor: '::',
							_0: _ak1211$tractor$PortfolioPage_Update$getPortfolios,
							_1: {ctor: '[]'}
						});
				} else {
					return A2(
			...
			case 'UrlChange':
				if (_p0._0.ctor === 'Portfolio') {
					...
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_ak1211$tractor$PortfolioPage_Model$clearModel(model),
						{ctor: '[]'});
				}
			case 'NewUrl':
				return A2(
		...
		switch (_p4.ctor) {
			...
			case 'UrlChange':
				if (_p4._0.ctor === 'Upload') {
					...
					return {
						ctor: '_Tuple2',
						_0: _ak1211$tractor$UploadPage_Model$clearModel(model),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			default:
		...
		if (_p0.ctor === 'Just') {
			...
			return A2(
				...
				_elm_lang$core$Native_Utils.update(
					model,
					{
						pageHistory: {ctor: '::', _0: _p4, _1: model.pageHistory}
					}),
				{
					ctor: '::',
					_0: A2(
					...
					_1: {
						...
						_0: function (_p1) {
							...
							_ak1211$tractor$Msg$UploadPageMsg(
								_ak1211$tractor$UploadPage_Msg$UrlChange(_p4))),
						_1: {
							ctor: '::',
							_0: function (_p2) {
								return A2(
								...
								_ak1211$tractor$Msg$PortfolioPageMsg(
									_ak1211$tractor$PortfolioPage_Msg$UrlChange(_p4))),
							_1: {
								ctor: '::',
								_0: function (_p3) {
									return A2(
									...
									_ak1211$tractor$Msg$AnalyticsPageMsg(
										_ak1211$tractor$AnalyticsPage_Msg$UrlChange(_p4))),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _ak1211$tractor$UploadPage_View$viewFileContent = F2(
	function (model, content) {
		...
		var _p3 = content;
		if (_p3.ctor === 'Ok') {
			return dijestContent(_p3._0);
		} else {
			return errorContent(_p3._0);
		}
	});
	...
	var viewRevision = function (v) {
		return {
			...
			_0: A3(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Git hash is'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A3(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(v.gitHash),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
	...
	var viewVersion = function (v) {
		return {
			...
			_0: A3(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Server version is'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A3(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(v.version),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
			...
			return A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: A2(_debois$elm_mdl$Material_Options$css, 'padding-bottom', '90px'),
							_1: {ctor: '[]'}
						},
						contents),
					_1: {
								...
								_0: A2(
									...
									},
									{
										...
										_0: A3(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(head),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
...
var _ak1211$tractor$View$drawerHeader = function (model) {
	return A3(
		_debois$elm_mdl$Material_Options$styled,
		_elm_lang$html$Html$header,
		{
			...
			_1: {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: A2(_debois$elm_mdl$Material_Options$css, 'padding', '20px'),
						_1: {
							ctor: '::',
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: A2(_debois$elm_mdl$Material_Options$css, 'font-family', '\'Gugi\', cursive'),
									_1: {
										ctor: '::',
										_0: A2(_debois$elm_mdl$Material_Options$css, 'font-size', '2.0rem'),
										_1: {
											ctor: '::',
											_0: A2(_debois$elm_mdl$Material_Options$css, 'letter-spacing', '0.25em'),
											_1: {
												ctor: '::',
												_0: _debois$elm_mdl$Material_Options$cs('drawer-header'),
												_1: {
													ctor: '::',
													_0: _debois$elm_mdl$Material_Color$background(
														A2(_debois$elm_mdl$Material_Color$color, _debois$elm_mdl$Material_Color$BlueGrey, _debois$elm_mdl$Material_Color$S900)),
															...
															_1: {
																...
																_0: _debois$elm_mdl$Material_Options$onClick(
																	_ak1211$tractor$Msg$NewUrl(
																		_ak1211$tractor$Route$toUrlPath(_ak1211$tractor$Route$Dashboard))),
																_1: {ctor: '[]'}
															}
														}
													}
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('TRACTOR'),
			_1: {ctor: '[]'}
		});
};
	...
	function (model, menuItem) {
		...
		var onClickCmd = function () {
			...
			if (_p4 === true) {
				...
				return _debois$elm_mdl$Material_Options$onClick(
					_ak1211$tractor$Msg$NewUrl(
						_ak1211$tractor$Route$toUrlPath(menuItem.route)));
			}
		}();
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					menuItem.iconName,
					{
						...
						_1: {
							ctor: '::',
							_0: A2(_debois$elm_mdl$Material_Options$css, 'margin-right', '26px'),
							_1: {ctor: '[]'}
						}
					}),
				_1: {
...
var _ak1211$tractor$View$menuItems = {
	ctor: '::',
	_0: {iconName: 'dashboard', route: _ak1211$tractor$Route$Dashboard},
	_1: {
		ctor: '::',
		_0: {iconName: 'file_upload', route: _ak1211$tractor$Route$Upload},
		_1: {
			ctor: '::',
			...
			_1: {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: {iconName: 'account_balance', route: _ak1211$tractor$Route$AccBalance},
						_1: {
							ctor: '::',
							_0: {iconName: 'school', route: _ak1211$tractor$Route$ApiDocument},
							_1: {ctor: '[]'}
						}
					}
				}
...
var _ak1211$tractor$View$viewDrawer = function (model) {
	return A2(
		...
		A2(
			...
			A2(
				_elm_lang$core$List$map,
				_ak1211$tractor$View$viewDrawerMenuItem(model),
...
var _ak1211$tractor$View$viewHeader = function (model) {
	var imgGitHub = A2(
		_elm_lang$html$Html$img,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$src('public/assets/GitHub-Mark-32px.png'),
			_1: {ctor: '[]'}
		},
		{ctor: '[]'});
	...
	return A2(
		_debois$elm_mdl$Material_Layout$row,
		{
			...
			_1: {
				ctor: '::',
				_0: _debois$elm_mdl$Material_Color$text(
					A2(_debois$elm_mdl$Material_Color$color, _debois$elm_mdl$Material_Color$BlueGrey, _debois$elm_mdl$Material_Color$S700)),
				_1: {ctor: '[]'}
			}
		},
		{
...
var _ak1211$tractor$View$pinkCard = function (contents) {
	return A2(
		_debois$elm_mdl$Material_Card$view,
		{
			ctor: '::',
...
var _ak1211$tractor$View$viewReports = function (model) {
	return _ak1211$tractor$View$pinkCard(
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('No Reports here.'),
			_1: {ctor: '[]'}
		});
};
	...
	switch (_p6.ctor) {
		...
		case 'AccBalance':
			return _ak1211$tractor$View$pinkCard(
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('No Contents here.'),
					_1: {ctor: '[]'}
				});
		default:
			return _ak1211$tractor$View$viewApiDocument(model);
	}
};
var _ak1211$tractor$View$dialogAbout = function (model) {
	return A2(
	...
	return A3(
		...
		A4(
			...
			},
			{
				header: {
					ctor: '::',
					_0: _ak1211$tractor$View$viewHeader(model),
					_1: {ctor: '[]'}
				},
				drawer: {
					ctor: '::',
					_0: _ak1211$tractor$View$drawerHeader(model),
					_1: {
						ctor: '::',
						_0: _ak1211$tractor$View$viewDrawer(model),
						_1: {ctor: '[]'}
					}
				},
				tabs: {
				...
				main: {
					ctor: '::',
					_0: _ak1211$tractor$View$viewBody(model),
					_1: {
						ctor: '::',
						_0: _ak1211$tractor$View$dialogAbout(model),
						_1: {ctor: '[]'}
					}
				}
			}));
};
var _ak1211$tractor$View$MenuItem = F2(
	function (a, b) {
	...
	function (flags, location) {
		var exchangeCode = function () {
			...
			if ((((_p0.ctor === 'Just') && (_p0._0.ctor === 'Home')) && (_p0._0._0.ctor === 'Nothing')) && (_p0._0._1.ctor === 'Just')) {
				return _ak1211$tractor$Main$exchangeOAuthCodeForToken(
					_ak1211$tractor$Generated_WebApi$AuthTempCode(_p0._0._1._0));
			} else {
				return _elm_lang$core$Platform_Cmd$none;
			}
		}();
		var _p1 = _ak1211$tractor$UploadPage_Model$init;
		var uploadPageModel = _p1._0;
		var uploadPageCmd = _p1._1;
		var _p2 = _ak1211$tractor$PortfolioPage_Model$init;
		var portfolioPageModel = _p2._0;
		var portfolioPageCmd = _p2._1;
		var _p3 = _ak1211$tractor$AnalyticsPage_Model$init;
		var analyticsPageModel = _p3._0;
		var analyticsPageCmd = _p3._1;
		var initialModel = {
		...
		var model = function () {
			var _p4 = _ak1211$tractor$Route$fromLocation(location);
			if (_p4.ctor === 'Just') {
				return _elm_lang$core$Native_Utils.update(
					initialModel,
					{
		...
		return A2(
			...
			model,
			{
				...
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$core$Platform_Cmd$map, _ak1211$tractor$Msg$AnalyticsPageMsg, analyticsPageCmd),
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$core$Platform_Cmd$map, _ak1211$tractor$Msg$PortfolioPageMsg, portfolioPageCmd),
						_1: {
							ctor: '::',
							_0: A2(_elm_lang$core$Platform_Cmd$map, _ak1211$tractor$Msg$UploadPageMsg, uploadPageCmd),
							_1: {
								ctor: '::',
...
var _ak1211$tractor$Main$main = A2(
	...
	{init: _ak1211$tractor$Main$init, view: _ak1211$tractor$View$view, subscriptions: _ak1211$tractor$Main$subscriptions, update: _ak1211$tractor$Update$update})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (client_id) {
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _ak1211$tractor$Main$main !== 'undefined') {
    _ak1211$tractor$Main$main(Elm['Main'], 'Main', undefined);
}
